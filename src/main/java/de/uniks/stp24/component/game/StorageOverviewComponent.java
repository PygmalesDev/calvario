...
public class StorageOverviewComponent extends AnchorPane {
    ...
    public void initStorageList() {
        if (!tokenStorage.isSpectator()) {
            ...
            this.resourceListView.setCellFactory(list -> explanationService.addMouseHoverListener(new CustomComponentListCell<>(app, resourceComponentProvider), "storage", null, null));
        }
    }
