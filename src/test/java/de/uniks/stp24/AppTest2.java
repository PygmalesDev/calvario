...
public class AppTest2 extends InGameTestComponent {
    ...
    private void openIslandOverview() {
        ...
        //assertTrue(this.inGameController.overviewSitesComponent.island_name.getText().equals("Plundered Island(Colony)")  || this.inGameController.overviewSitesComponent.island_name.getText().equals("Geplünderte Insel(Kolonie)"));
    }
