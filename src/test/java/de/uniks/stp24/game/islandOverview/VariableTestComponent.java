...
public class VariableTestComponent extends ControllerTest {
    @Spy
    ...
    public void initComponents(){
        ...
        ExplainedVariableDTO explainedVariableDTO4 = new ExplainedVariableDTO("systems.colonized.cost.minerals", 100, new ArrayList<Sources>(), 100);
        ExplainedVariableDTO explainedVariableDTO5 = new ExplainedVariableDTO("systems.colonized.cost.energy", 100, new ArrayList<Sources>(), 100);
        ExplainedVariableDTO explainedVariableDTO6 = new ExplainedVariableDTO("systems.colonized.upkeep.energy", 1, new ArrayList<Sources>(), 1);
        ExplainedVariableDTO explainedVariableDTO7 = new ExplainedVariableDTO("systems.colonized.upkeep.minerals", 1, new ArrayList<Sources>(), 1);
        ExplainedVariableDTO explainedVariableDTO8 = new ExplainedVariableDTO("systems.colonized.upkeep.fuel", 1, new ArrayList<Sources>(), 1);

        ExplainedVariableDTO explainedVariableDTO9 = new ExplainedVariableDTO("systems.upgraded.cost.minerals", 100, new ArrayList<Sources>(), 100);
        ExplainedVariableDTO explainedVariableDTO10 = new ExplainedVariableDTO("systems.upgraded.cost.alloys", 100, new ArrayList<Sources>(), 100);
        ExplainedVariableDTO explainedVariableDTO11 = new ExplainedVariableDTO("systems.upgraded.upkeep.energy", 2, new ArrayList<Sources>(), 2);
        ExplainedVariableDTO explainedVariableDTO12 = new ExplainedVariableDTO("systems.upgraded.upkeep.minerals", 2, new ArrayList<Sources>(), 2);
        ExplainedVariableDTO explainedVariableDTO13 = new ExplainedVariableDTO("systems.upgraded.upkeep.fuel", 2, new ArrayList<Sources>(), 2);
        ExplainedVariableDTO explainedVariableDTO14 = new ExplainedVariableDTO("systems.upgraded.upkeep.alloys", 1, new ArrayList<Sources>(), 1);

        ExplainedVariableDTO explainedVariableDTO15 = new ExplainedVariableDTO("systems.developed.cost.fuel", 200, new ArrayList<Sources>(), 200);
        ExplainedVariableDTO explainedVariableDTO16 = new ExplainedVariableDTO("systems.developed.cost.alloys", 100, new ArrayList<Sources>(), 100);
        ExplainedVariableDTO explainedVariableDTO17 = new ExplainedVariableDTO("systems.developed.upkeep.energy", 4, new ArrayList<Sources>(), 4);
        ExplainedVariableDTO explainedVariableDTO18 = new ExplainedVariableDTO("systems.developed.upkeep.minerals", 4, new ArrayList<Sources>(), 4);
        ExplainedVariableDTO explainedVariableDTO19 = new ExplainedVariableDTO("systems.developed.upkeep.fuel", 4, new ArrayList<Sources>(), 4);
        ExplainedVariableDTO explainedVariableDTO20 = new ExplainedVariableDTO("systems.developed.upkeep.alloys", 3, new ArrayList<Sources>(), 3);
        ...
        explainedVariableDTOS.add(explainedVariableDTO4);
        explainedVariableDTOS.add(explainedVariableDTO5);
        explainedVariableDTOS.add(explainedVariableDTO6);
        explainedVariableDTOS.add(explainedVariableDTO7);
        explainedVariableDTOS.add(explainedVariableDTO8);
        explainedVariableDTOS.add(explainedVariableDTO9);
        explainedVariableDTOS.add(explainedVariableDTO10);
        explainedVariableDTOS.add(explainedVariableDTO11);
        explainedVariableDTOS.add(explainedVariableDTO12);
        explainedVariableDTOS.add(explainedVariableDTO13);
        explainedVariableDTOS.add(explainedVariableDTO14);
        explainedVariableDTOS.add(explainedVariableDTO15);
        explainedVariableDTOS.add(explainedVariableDTO16);
        explainedVariableDTOS.add(explainedVariableDTO17);
        explainedVariableDTOS.add(explainedVariableDTO18);
        explainedVariableDTOS.add(explainedVariableDTO19);
        explainedVariableDTOS.add(explainedVariableDTO20);
